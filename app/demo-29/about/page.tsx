	...
	<div className="relative">
		...
		<div className="w-full flex flex-col md:flex-row gap-6 m-4">
			<div className="w-full md:w-1/2 py-4 my-4">
				<h2 className="w-full bg-zinc-100 text-blue-800 text-xl font-bold py-4 my-4">Komitmen pada kami</h2>
				...
				<p className="mt-8">Kami berkomitmen pada penyediaan daging ayam kampung yang sehat dan menyehatkan,
				kualitas yang terpercaya (halal, sehat, dan bersih), serta pelestarian lingkungan.</p>
			</div>
			
			<div className="w-full md:w-1/2 py-4 my-4">
				<h2 className="w-full bg-zinc-100 text-blue-800 text-xl font-bold py-4 my-4">Mengapa memilih kami</h2>
				<div className="relative w-full h-auto mx-auto flex text-center justify-center">
					<Image 
				...
				<p className="mt-8">Karena Kami menghasilkan daging ayam kampung berkualitas dan sehat, dibesarkan dengan cara pemeliharaan alami, 
