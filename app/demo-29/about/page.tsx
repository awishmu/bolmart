...
export default function AboutUs() {
  ...
  <div className="w-full">
	...
	<div className="relative">
		<div className="w-full flex flex-col justify-center md:flex-row md:justify-between mx-4">
		...
		<div className="">
			...
			<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 ">
				...
				<div className="lg:w-full">
					<div className="w-8 h-8 bg-rose-200"></div>
					<div>
		...
		<div>
			<h2>Komitmen</h2>
			<p>Kami berkomitmen pada penyediaan daging ayam kampung yang sehat dan menyehatkan,
			kualitas yang terpercaya (halal, sehat, dan bersih), serta pelestarian lingkungan.</p>
		</div>
		
		<div>
			<h2>Mengapa memilih kami</h2>
			<p>Karena Kami menghasilkan daging ayam kampung berkualitas dan sehat, dibesarkan dengan cara pemeliharaan alami, 
