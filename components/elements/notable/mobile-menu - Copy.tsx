...
export function MobileMenuCopy() {
    return (
                                ...
                                <div className="nav-wrapper mx-2 py-2">
                                    <nav className="99 text-white flex flex-col">
                                        <ul id="menu-main-menu" className="mobile-menu px-4">
                                            <li className="menu-item border-2 p-2 mb-2"><Link href="#">Meat</Link></li>
                                            ...
                                            <li className="menu-item border-2 p-2 mb-2"><Link href="#">Minuman</Link>
                                                <ul id="megamenu mp-left" className="w-[457px] absolute">
                                                    <li className="menu-item border-2 p-2 mb-2">Jamu</li>
													<li className="menu-item border-2 p-2 mb-2">Racikan</li>
                                                </ul>
                                            </li>
                                            <li className="menu-item border-2 p-2 mb-2"><Link href="#">Seafood</Link></li>
                                            <li className="menu-item border-2 p-2 mb-2"><Link href="#">Recipe</Link></li>
                                            <li className="menu-item border-2 p-2 mb-2"><Link href="#">Bakery & Snack</Link>
                                                <ul id="megamenu mp-left" className="w-[756px] absolte">
                                                    <li className="menu-item border-2 p-2 mb-2">Panggang</li>
													<li className="menu-item border-2 p-2 mb-2">Kukus</li>
													<li className="menu-item border-2 p-2 mb-2">Gorengan</li>
                                                </ul>
                                            </li>
                                            <li className="menu-item border-2 p-2 mb-2"><Link href="#">Promo</Link></li>
                                            <li className="menu-item border-2 p-2 mb-2"><Link href="#">About us</Link></li>
                                        </ul>
                                    </nav>			
                                </div>
